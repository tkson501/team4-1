<template>
    ...
    <v-card style="width:450px;" outlined>
        ...
        <v-card-actions>
            ...
            <v-dialog v-model="wrapDiagram" width="500">
                <WrapCommand
                        @closeDialog="closeWrap"
                        @wrap="wrap"
                ></WrapCommand>
            </v-dialog>
        </v-card-actions>
    ...
    export default {
        ...
        methods: {
            ...
            async wrap(params) {
                try {
                    if(!this.offline) {
                        var temp = await axios.put(axios.fixUrl(this.value._links['wrap'].href), params)
            ...
            openWrap() {
                this.wrapDiagram = true;
            },
            closeWrap() {
                this.wrapDiagram = false;
            },
        },
    }
</script>
